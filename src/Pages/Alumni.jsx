export default function Alumni() {
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-display font-bold text-[#1a3c5e]">Alumni</h1>
        <p className="text-gray-500 text-sm mt-1">Connect with our alumni network</p>
      </div>
      <div className="bg-white rounded-2xl border border-gray-100 p-12 text-center shadow-sm">
        <div className="w-16 h-16 bg-[#1a3c5e]/10 rounded-2xl flex items-center justify-center mx-auto mb-4">
          <span className="text-3xl">校友</span>
        </div>
