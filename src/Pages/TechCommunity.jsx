export default function TechCommunity() {
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-display font-bold text-[#1a3c5e]">Tech Community</h1>
        <p className="text-gray-500 text-sm mt-1">Connect with other tech enthusiasts</p>
      </div>
